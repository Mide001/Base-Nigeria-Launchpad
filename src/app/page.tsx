        ...
        <div className="container mx-auto px-4 pt-8 sm:pt-16 pb-12 sm:pb-24 grid md:grid-cols-2 gap-8 sm:gap-12 items-center relative z-10">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
              <button className="bg-emerald-600/90 backdrop-blur-sm text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg flex items-center justify-center space-x-2 hover:bg-emerald-600 transition text-sm sm:text-base">
