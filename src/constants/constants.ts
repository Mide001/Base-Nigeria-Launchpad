export const BaseAfricaDaoABI: any[] = [
	{
		"inputs": [],
		...
		"outputs": [
			{
				...
				"internalType": "struct BaseAfricaDAO.Comment[]",
				"name": "",
				"type": "tuple[]"
			}
		],
...
export const BaseAfricaDaoAddress = "0x6A8Aa702c2AE0bdFFC3dE3E680888ADaa39b0597";
